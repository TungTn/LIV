<?php
/**
 * The template for displaying Spa Detail Page.
 * @package Miyatsu
 * Template Name: Spa Details
**/ 
?> 
<?php 
	get_header();
	global $wp_query, $post;
	$terms = get_the_terms( $post->ID, 'spa' );
	$args = array(
		'post_type'			=> 'spas', 
		'post_status'		=> 'publish',
		'posts_per_page' 	=> -1,
							...
							<div class="restaurant-details-add">
									...
									<ul id="ratecv">
										...
										<li>
											...
											<span block-sc-pc>
												...
												of <?php echo count($total_post);?> Spas in <?php echo $primary_term->name;?>
											</span>
										</li>
									</ul>
								</div>
								<div class="ranking" block-sc-sp>								
									<span>
										...
										of <?php echo count($total_post);?> Spas in <?php $primary_term->name;?>
									</span>
								</div>
