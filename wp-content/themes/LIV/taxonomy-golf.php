<?php
/**
 * The template for displaying Golf List Page.
 * @package Miyatsu
 * Template Name: Golf List
**/
?>
<?php get_header(); ?>
<?php
					...
					<?php if($key < 4):?>
						<div class="swiper-slide mv__item" data-background="<?php echo get_stylesheet_directory_uri();?>/assets/images/restaurant_list/mv_bg.png">
							<div class="content">
								...
								<?php endif;?>
								<a href="<?php echo get_the_permalink($restaurant); ?>" class="news">Golf Area of the Month</a>
							</div>
						</div>
					<?php else:?>
						<?php break;?>
			...
			<?php else:?>
				<div class="swiper-slide mv__item" data-background="<?php echo get_stylesheet_directory_uri();?>/assets/images/restaurant_list/mv_bg.png">
					<div class="content">
						...
						<a href="javascript:void(0)" class="news">Golf Area of the Month</a>
					</div>
				</div>
				<div class="swiper-slide mv__item" data-background="<?php echo get_stylesheet_directory_uri();?>/assets/images/restaurant_list/mv_bg.png">
				</div>
