<?php
/**
 * The template for displaying Life Info List Page.
 * @package Miyatsu
 * Template Name: Life Info List
**/
?>
<?php get_header(); ?>
          ...
          <div class="content">
            <div class="info">
              ...
              <div class="box">
                ...
                <h2 class="tit" block-sc-sp>Life Info Of <?php echo $category->name;?></h2>
                <div class="dropdown">
                  <form id="sort_select_form" data-taxonomy-term="<?php echo $category->slug;?>" data-post-taxonomy="<?php echo $category->taxonomy;?>" data-post-type="lifes" data-post-per-page="14" method="post" data-page-type="lifes" data-url="<?php echo site_url() ?>/wp-admin/admin-ajax.php">
