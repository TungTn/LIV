...
<div class="IssueArea" block-sc-sp>
          ...
          <div class="content">
            ...
            <div class="today_news">
              <div class="today_news_block">
                  ...
                  <h2 class="todays_news_ttl">Issues In <?php echo $category->name;?></h2>
                <div class="dropdown">
                  <form id="sort_select_form" method="post" data-post-per-page="5" data-taxonomy-term="<?php echo $category->slug;?>" data-post-taxonomy="<?php echo $category->taxonomy;?>" data-post-type="issues" data-page-type="issue" data-url="<?php echo site_url() ?>/wp-admin/admin-ajax.php">
            ...
            <?php if($mvn_pagenavi['max-paged'] > 1):?>
              <div class="see_more">
                <a data-page-type="issue" data-taxonomy-term="<?php echo $category->slug;?>" data-post-taxonomy="<?php echo $category->taxonomy;?>" data-sort="DESC" data-key="<?php echo esc_attr($mvn_pagenavi['key']) ?>" data-disable="0" data-max-paged="<?php echo esc_attr($mvn_pagenavi['max-paged']) ?>" data-paged="2" class="btn btn__ajax--loadmore">
