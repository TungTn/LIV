<?php
/**
 * The template for displaying Tour List Page.
 * @package Miyatsu
          ...
          <div class="content">
            ...
            <div class="info">
              <div class="box">
                ...
                <div class="dropdown">
                  <form id="sort_select_form" data-taxonomy-term="<?php echo $category->slug;?>" data-post-taxonomy="<?php echo $category->taxonomy;?>" data-post-type="tours" data-post-per-page="14" method="post" data-page-type="lifes" data-url="<?php echo site_url() ?>/wp-admin/admin-ajax.php">
                      ...
                      <li class="item item__first">
                        <a href="<?php echo get_the_permalink($post->ID); ?>">
                          <div class="image-list">
                            ...
                            <?php else:?>
                              <div class="img" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/news_info/news_01.png'></div>                          
                            <?php endif;?>
                          </div>
                        </a>
                        <div class="content">
            ...
            <?php if($mvn_pagenavi['max-paged'] > 1):?>
              <div class="see_more">
                <a  data-page-type="life-info" data-taxonomy-term="<?php echo $category->slug;?>" data-post-taxonomy="<?php echo $category->taxonomy;?>" data-sort="DESC" data-key="<?php echo esc_attr($mvn_pagenavi['key']) ?>" data-disable="0" data-max-paged="<?php echo esc_attr($mvn_pagenavi['max-paged']) ?>" data-paged="2" class="btn btn__ajax--loadmore">
