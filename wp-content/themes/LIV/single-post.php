	...
	<section class="mvArea">
		<div class="swiper-container mv" id="mv">
			<div class="swiper-wrapper">
				<div class="swiper-slide mv__item" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/news_info/mv_bg.jpg'>
				</div>
				<div class="swiper-slide mv__item" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/news_info/mv_bg.jpg'>
				</div>
				<div class="swiper-slide mv__item" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/news_info/mv_bg.jpg'>
												...
												<div class="img">
													<?php if ( has_post_thumbnail($r_post->ID) ): ?>
														<a href="<?php echo get_the_permalink($r_post->ID); ?>">
															<img src="<?php echo mvn_get_attachment_image_src(get_post_thumbnail_id($r_post->ID),'mvn_200x200'); ?>" alt="">
														</a>
													<?php endif;?>
												</div>
												<div class="in">
