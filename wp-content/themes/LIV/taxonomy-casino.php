<?php
/**
 * The template for displaying Casino List Page.
 * @package Miyatsu
			...
			<div class="swiper-wrapper">
				<?php if($restaurants_of_month):?>
					<?php foreach( $restaurants_of_month as $key => $restaurant ):?>
						<?php if($key < 4):?>
							<div class="swiper-slide mv__item" data-background="<?php echo get_stylesheet_directory_uri();?>/assets/images/casino/mv_bg.png">
								<div class="content">
									...
									<?php endif;?>
									<a href="<?php echo get_the_permalink($restaurant); ?>" class="news">Casino of the Month</a>
								</div>
							</div>
						<?php else:?>
							<?php break;?>
				...
				<?php else:?>
					<div class="swiper-slide mv__item" data-background="<?php echo get_stylesheet_directory_uri();?>/assets/images/casino/mv_bg.png">
						<div class="content">
							...
							<a href="javascript:void(0)" class="news">Casino of the Month</a>
						</div>
					</div>
					<div class="swiper-slide mv__item" data-background="<?php echo get_stylesheet_directory_uri();?>/assets/images/casino/mv_bg_01.png">
					</div>
					<div class="swiper-slide mv__item" data-background="<?php echo get_stylesheet_directory_uri();?>/assets/images/casino/mv_bg_02.png">
					</div>
				<?php endif;?>
			</div>
			<!-- Add Pagination -->
