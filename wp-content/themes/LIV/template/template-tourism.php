<?php
/**
 * The template for displaying Tour Page.
 * @package Miyatsu
 * Template Name: Tour
**/
		...
		<div class="swiper-container mv" id="mv">
			<div class="swiper-wrapper">
				...
				?>
					...
					<?php endforeach;?>
				<?php else: ?>
					<a href="#" class="swiper-slide mv__item" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/touris/mv_bg.png'>
						<div class="content">
							<h2 class="tit">Tour in Vietnam</h2>
						</div>
					</a>
					<a href="#" class="swiper-slide mv__item" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/touris/mv_bg.png'>
					</a>
