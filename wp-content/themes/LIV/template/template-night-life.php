<?php
/**
 * The template for displaying Night Life Page.
 * @package Miyatsu
 * Template Name: Night Life
**/
		...
		<div class="swiper-container mv" id="mv">
			<div class="swiper-wrapper">
				...
				?>
					...
					<?php endforeach;?>
				<?php else: ?>
					<a href="#" class="swiper-slide mv__item" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/nightlife/mv_bg.png'>
						<div class="content">
							<h2 class="tit">Night Life in Vietnam</h2>
						</div>
					</a>
					<a href="#" class="swiper-slide mv__item" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/nightlife/mv_bg.png'>
					</a>
					...
					<div class="content">
						<div class="new_info">
							...
							<!-- <div class="other-areas">
								<a href="#">
									<img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/restaurant_icon_color.png" class="middle">
