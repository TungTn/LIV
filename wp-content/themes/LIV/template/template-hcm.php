<?php
/**
* The template for displaying Ho Chi Minh Page.
* @package Miyatsu
* Template Name: Ho Chi Minh
**/
...
<div class="listpageArea" block-sc-sp>
	<section class="mvArea">
		<div class="mv">				
			<div class="mv__item" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/listpage/hcm.png'>
				<div class="content">
					<h2 class="tit">Ho Chi Minh <br>City</h2>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="main">
					<div class="content">
						...
						<div class="issue">
							...
							?>
							<div class="title">
								<a href="javascript:avoid(0)" class="link-default">Issue in HCM city</a>
								<?php if($issues_query->max_num_pages > 0 ) :?>
									<a href="<?php echo get_site_url();?>/issue/ho-chi-minh" class="see-all"><span class="txt">See all</span></a>
								<?php endif;?>
							</div>
						...
						<div class="life_info">
							...
							?>
							<div class="title">
								<a href="javascript:avoid(0)" class="link-default">Life info of HCM city</a>
								<?php if($lifes_query->max_num_pages > 0 ) :?>
									<a href="<?php echo get_site_url();?>/life/ho-chi-minh" class="see-all"><span class="txt">See all</span></a>
								<?php endif;?>
							</div>									
