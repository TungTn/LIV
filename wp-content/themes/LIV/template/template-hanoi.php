<?php
/**
* The template for displaying Ha noi Page.
* @package Miyatsu
* Template Name: Hanoi
**/
?>
...
<div class="listpageArea" block-sc-sp>
	<section class="mvArea">
		<div class="mv">
			<div class="mv__item" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/listpage/ha-noi.png'>
				<div class="content">
					<h2 class="tit">Hanoi</h2>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="main">
					<div class="content">
						...
						<div class="issue">
							...
							?>
							<div class="title">
								<a href="javascript:avoid(0)" class="link-default">Issue in Hanoi</a>
								<?php if($issues_query->max_num_pages > 0 ) :?>
									<a href="<?php echo get_site_url();?>/issue/ha-noi" class="see-all"><span class="txt">See all</span></a>
								<?php endif;?>
							</div>
						...
						<div class="life_info">
							...
							?>
							<div class="title">
								<a href="javascript:avoid(0)" class="link-default" block-sc-sp>Life info of Hanoi</a>
								<?php if($lifes_query->max_num_pages > 0 ) :?>
									<a href="<?php echo get_site_url();?>/life/ha-noi" class="see-all" block-sc-sp><span class="txt">See all</span></a>
								<?php endif;?>
							</div>
