<?php
/**
 * The template for displaying Casino Page.
 * @package Miyatsu
		...
		<div class="swiper-container mv" id="mv">
			<div class="swiper-wrapper">
				...
				?>
					...
					<?php endforeach;?>
				<?php else: ?>
					<a href="#" class="swiper-slide mv__item" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/casino/mv_bg.png'>
						<div class="content">
							<h2 class="tit">Casino in Vietnam</h2>
						</div>
					</a>
					<a href="#" class="swiper-slide mv__item" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/casino/mv_bg_01.png'>
					</a>
					<a href="#" class="swiper-slide mv__item" data-background='<?php echo get_stylesheet_directory_uri();?>/assets/images/casino/mv_bg_02.png'>
					</a>
				<?php endif;?>
			</div>
			<!-- Add Pagination -->
										...
										<li class="item">
											<div class="img">
												...
												<span class="text-centered">
													...
													<a href="<?php echo get_term_link($term->term_id); ?>" block-sc-pc class="seemore"><span>See More</span></a>
												</span>
											</div>
										</li>
									<?php endforeach;?>
